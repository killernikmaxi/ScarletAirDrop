        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (secondsUntilEvent <= 0) {
                    if (!ScarletAirDrop.INSTANCE.getConfig().getBoolean("Settings.BETA") && Bukkit.getOnlinePlayers().size() < ScarletAirDrop.INSTANCE.getConfig().getInt("Settings.AirDrop.min-online")) {
